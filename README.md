...
- Uses Windows Package Manager when available
- Falls back to a checksum-verified installer downloaded from the official Node.js site
...
The launcher finds Node.js even when `npm` is missing from PowerShell's `PATH`
